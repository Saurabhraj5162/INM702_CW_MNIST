...
def test_backward_propagation():
  ...
  A_last = np.array([[1.78862847, 0.43650985]])
  Y = np.array([[1, 0]])
  memory = (((np.array([[ 0.09649747, -1.8634927 ],
  ...
  grads = my_model.backward_propagation(A_last, Y, memory, activation_functions)
  print(np.round(np.sum(grads['dA1']),4))
  print(np.round(np.sum(np.array([[ 0.12913162, -0.44014127],[-0.14175655,  0.48317296],[ 0.01663708, -0.05670698]])),4))
  assert np.round(np.sum(grads['dA0']),4) == -0.8792
  assert np.round(np.sum(grads['dA1']),4) == np.round(np.sum(np.array([[ 0.12913162, -0.44014127],[-0.14175655,  0.48317296],[ 0.01663708, -0.05670698]])),4)
  assert np.round(np.sum(grads['dW1']),4) == np.round(np.sum(np.array([[0.41010002, 0.07807203, 0.13798444, 0.10502167],[0.,0.,0.,0.],[0.05283652, 0.01005865, 0.01777766, 0.0135308 ]])),4)
  assert np.round(np.sum(grads['dW2']),4) == np.round(np.sum(np.array([[-0.39202432, -0.13325855, -0.04601089]])),4)
  assert np.round(np.sum(grads['db1']),4) == np.round(np.sum(np.array([[-0.22007063],[ 0.],[-0.02835349]])),4)
  assert np.round(np.sum(grads['db2']),4) == np.round(np.sum(np.array([[[0.15187861]]])),4)

  print("backward_propagation working CORRECTLY")
