...
class My_Neural_Network():
  def __init__(self,X,Y, input_shape,n_classes,layers_list,
  ...
  #def gradient_check(parameters, gradients, X, Y, epsilon=1e-7, print_msg=False):
  ...
  def train(self, print_cost=True):
      ...
      for i in range(0, self.num_iterations):
          ...
          A_last, memory = self.forward_propagation(self.X, params, self.activation_functions)
          ...
          if self.lambd == 0:
            ...
            cost = self.calculate_cost_L2_regularised(A_last, self.Y, params, self.lambd)
          #cost = self.calculate_cost(A_last, self.Y)
                  
          # Backward propagation.
          if self.lambd==0:
            grads = self.backward_propagation(A_last, self.Y, memory, self.activation_functions)
          elif self.lambd !=0:
            grads = self.backward_propagation_L2_regularised(A_last, self.Y, memory, self.activation_functions, self.lambd)
...
my_model = My_Neural_Network(X,Y,input_shape,n_classes,layers_list,activation_functions, weight_initializer,learning_rate,num_iterations)

#parameters, costs =  my_model.train()
...
my_model_drop = My_Neural_Network(X,Y,input_shape,n_classes,layers_list,activation_functions, weight_initializer,learning_rate,num_iterations,lambd,drop_rate)
